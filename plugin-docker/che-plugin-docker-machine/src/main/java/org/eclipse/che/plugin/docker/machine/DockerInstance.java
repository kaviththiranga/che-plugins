...
public class DockerInstance implements Instance {
    ...
    @Override
    public InstanceSnapshotKey saveToSnapshot(String owner, String label) throws MachineException {
        try {
            ...
            return new DockerInstanceSnapshotKey(repository, null, imageId, registry);
        } catch (IOException e) {
            throw new MachineException(e);
